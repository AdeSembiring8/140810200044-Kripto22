...
void findInverse(int m[3][3] , int n , int m_inverse[3][3] )
{
    ...
    int det = determinan(m , n); // ini menggunakan fungsi determinan(matrix , order_of_matrix)
...
string dekripsi(string ct, int n)
{
    ...
    /* perkalianMatrix(mat_a , row_a , col_a , mat_b, row_b, col_b , mat_result) */
